...
namespace MyEshop.Areas.Admin.Controllers
{
    public class FeaturesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FeaturesID,FeaturesTitle")] Features features)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FeaturesID,FeaturesTitle")] Features features)
        {
            if (ModelState.IsValid)
            {
